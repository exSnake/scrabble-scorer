...
<template>
  ...
  >
    <div class="container flex flex-wrap items-center justify-between mx-auto">
      ...
      <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
        ...
        >
          <li>
            <RouterLink
              to="/"
              class="block py-2 pl-3 pr-4 bg-blue-700 rounded md:bg-transparent md:p-0 dark:bg-blue-600 md:dark:bg-transparent"
            >
              Home
            </RouterLink>
          </li>
      ...
      <button
        data-tooltip-target="navbar-user-example-toggle-dark-mode-tooltip"
        type="button"
        @click="toggleDark()"
